import type { QueryFilters, ShareRow } from "../../client/protocol";
import { ensureDb } from "../engine";
import { queryWithParams } from "../sql";
import { buildWhere, clampInt, num, replyOk, str, toRows } from "./common";
...
export async function handleQueryShare(
  ...
  const orderExpr = rankBy === "totalTimeMs" ? "total_time_ms" : "total_cpu_ms";
